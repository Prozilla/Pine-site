...
This class is often called `Main` and always has a method `public static void main(String[] args)`. 
In our case, we will be using this method to prepare and run our application using the <JavadocLink name="dev.prozilla.pine.core.ApplicationBuilder"/>.
