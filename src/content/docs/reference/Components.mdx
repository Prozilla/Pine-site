...
Components are created by extending the [`Component`](https://javadoc.pine.prozilla.dev/dev/prozilla/pine/core/component/Component.html) class.

### Example

```java
public SpriteRenderer extends Component {
